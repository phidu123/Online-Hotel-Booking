        ...
        <div>
            <form method="post">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="type" value="<?php echo $row['TEN_LOAIPHONG'] ?>">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" name="price" value="<?php echo $row['GIA'] ?>">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    <label for="name" class="col-sm-2 col-form-label">Features</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" name="facilities" value="<?php echo $row['FACILITIES'] ?>">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <br>
                        <!-- <img  src="./upload/categories/<?php echo $row['HINHANH']?>"> -->
                    </div>
                </div>
...
<?php 
    if (isset($_POST['edit'])){
        $id = $_GET['id'];
        $sql = "UPDATE `ds_loaiphong` set `TEN_LOAIPHONG`='$_POST[type]', `GIA`='$_POST[price]', `FEATURES`='$_POST[features]', `FACILITIES`='$_POST[facilities]', `HINHANH`='$_POST[img]' where `ID_LOAIPHONG`='$id'";
        $run = mysqli_query($connection, $sql);
        if ($run){
